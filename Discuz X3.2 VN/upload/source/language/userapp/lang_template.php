...
$lang = array (
  ...
  'user_assistant_message' => '<ol><li>Bạn được tự do để kéo và thả <img src="{IMGDIR}/drag.gif" /> Các ứng dụng được sắp xếp theo thứ tự;</li>
								<li>Hiển thị ứng dụng ở thành trình đơn.</li>
								<li>Bạn có thể quản lý ứng dụng của bạn đã được thêm vào, bạn có thể thiết lập quyền cho một ứng dụng, gỡ bỏ một ứng dụng;</li>
								<li>Nếu bạn muốn bảo mật cho không gian của bạn. Hãy đăng nhập và chọn chế độ bảo mật.</li>
								<li>Cài đặt ứng dụng mặc định và chỉ có thể được gỡ bỏ, nhưng sau khi gỡ bỏ phần còn lại sẽ được hiển thị trong menu của bạn ở bên phải.</li></ol>',
  'open' => 'Mở rộng',
