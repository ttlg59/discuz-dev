...
if(!@include UC_DATADIR.'config.inc.php') {
	exit('Tập tin<b>data/config.inc.php</b> không được tìm thấy, Có thể bạn chưa cài đặt UC hãy xem lại,hoặc <a href="install/index.php"><b>Nhấn để cài đặt.</b></a>.');
}
