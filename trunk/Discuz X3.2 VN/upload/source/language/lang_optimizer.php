...
$lang = array
(
	'optimizer_dbbackup_advice'	=> 'Sao lưu đã không được thực hiện trong vòng 3 tháng, bạn nên sao lưu dữ liệu của bạn ngay lập tức.',//'三个月没有进行数据备份了,建议立即备份数据',
	'optimizer_dbbackup_lastback'	=> 'Sao lưu dữ liệu cuối cùng được thực hiện vào lúc:',//'上次数据备份于',
	'optimizer_dbbackup_clean_safe'	=> 'Tập tin sao lưu cơ sở dữ liệu không được tìm thấy.',//'没有检测到数据库备份文件，无安全问题',
 ...
 'optimizer_attachrefcheck_need'			=> 'This setting can play an anti-hotlinking role',//'设置后可以起到防盗链的作用',
	...
	'optimizer_security_daily_no_need'			=> 'Nhiệm vụ theo lịch trình được kích hoạt',//'该计划任务已开启',
);
?>